...
/**
 * Abstract base class for {@link League} specific assertions - Generated by
 * CustomAssertionGenerator.
 */
@javax.annotation.Generated(value="assertj-assertions-generator")
public abstract class AbstractLeagueAssert<S extends AbstractLeagueAssert<S, A>, A extends League> extends AbstractBaseEntityAssert<S, A> {

	/**
	 * Creates a new <code>{@link AbstractLeagueAssert}</code> to make assertions on
	 * actual League.
	 * 
	 ...
	 * 
	 * @param leagueCode the given leagueCode to compare the actual League's
	 *                   leagueCode to.
	 * @return this assertion object.
	 * @throws AssertionError - if the actual League's leagueCode is not equal to
	 *                        the given one.
	 */
	 ...
	 * 
	 * @param leagueDate the given leagueDate to compare the actual League's
	 *                   leagueDate to.
	 * @return this assertion object.
	 * @throws AssertionError - if the actual League's leagueDate is not equal to
	 *                        the given one.
	 */
	 ...
	 * 
	 * @param team the given elements that should be contained in actual League's
	 *             team.
	 * @return this assertion object.
	 * @throws AssertionError if the actual League's team does not contain all given
	 *                        Team elements.
	 */
	...
	/**
	 * Verifies that the actual League's team contains the given Team elements in
	 * Collection.
	 * 
	 * @param team the given elements that should be contained in actual League's
	 *             team.
	...
	/**
	 * Verifies that the actual League's team contains <b>only</b> the given Team
	...
	/**
	 * Verifies that the actual League's team does not contain the given Team
	 * elements.
	 *
	 * @param team the given elements that should not be in actual League's team.
	 * @return this assertion object.
	 * @throws AssertionError if the actual League's team contains any given Team
	 *                        elements.
	 */
	public S doesNotHaveTeam(Team... team) {
		...
		// check with standard error message (use overridingErrorMessage before contains
