...
public abstract class AbstractMessageAssert<S extends AbstractMessageAssert<S, A>, A extends Message> extends AbstractBaseEntityAssert<S, A> {
   ...
   */
  public S hasUsernamereceive(org.springframework.samples.dreamgp.model.User usernamereceive) {
    // check that actual Message we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    org.springframework.samples.dreamgp.model.User actualUsernamereceive = actual.getUsernamereceive();
   ...
   */
  public S hasUsernamesend(org.springframework.samples.dreamgp.model.User usernamesend) {
    // check that actual Message we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    org.springframework.samples.dreamgp.model.User actualUsernamesend = actual.getUsernamesend();
