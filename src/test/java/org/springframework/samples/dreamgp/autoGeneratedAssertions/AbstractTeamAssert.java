...
public abstract class AbstractTeamAssert<S extends AbstractTeamAssert<S, A>, A extends Team> extends AbstractBaseEntityAssert<S, A> {
   ...
   */
  public S hasLeague(org.springframework.samples.dreamgp.model.League league) {
    ...
    // null safe check
    org.springframework.samples.dreamgp.model.League actualLeague = actual.getLeague();
