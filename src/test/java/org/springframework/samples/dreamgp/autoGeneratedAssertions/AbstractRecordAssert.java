...
public abstract class AbstractRecordAssert<S extends AbstractRecordAssert<S, A>, A extends Record> extends AbstractBaseEntityAssert<S, A> {
   ...
   */
  public S hasMejorVuelta(org.springframework.samples.dreamgp.model.RecordMejorVuelta mejorVuelta) {
    ...
    // null safe check
    org.springframework.samples.dreamgp.model.RecordMejorVuelta actualMejorVuelta = actual.getMejorVuelta();
   ...
   */
  public S hasRecordDelCircuito(org.springframework.samples.dreamgp.model.RecordCircuito recordDelCircuito) {
    // check that actual Record we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    org.springframework.samples.dreamgp.model.RecordCircuito actualRecordDelCircuito = actual.getRecordDelCircuito();
   ...
   */
  public S hasVueltaDePole(org.springframework.samples.dreamgp.model.RecordPole vueltaDePole) {
    // check that actual Record we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    org.springframework.samples.dreamgp.model.RecordPole actualVueltaDePole = actual.getVueltaDePole();
   ...
   */
  public S hasVueltaRapida(org.springframework.samples.dreamgp.model.RecordVueltaRapida vueltaRapida) {
    // check that actual Record we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    org.springframework.samples.dreamgp.model.RecordVueltaRapida actualVueltaRapida = actual.getVueltaRapida();
   ...
   */
  public S hasGp(org.springframework.samples.dreamgp.model.GranPremio gp) {
    // check that actual Record we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    org.springframework.samples.dreamgp.model.GranPremio actualGp = org.assertj.core.util.introspection.FieldSupport.EXTRACTION.fieldValue("gp", org.springframework.samples.dreamgp.model.GranPremio.class, actual);
